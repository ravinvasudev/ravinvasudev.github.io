    ...
    >
      ...
      <div className="shell relative grid gap-12 py-16 lg:grid-cols-[1.25fr_1fr] lg:items-center lg:py-24">
        <motion.div initial="hidden" animate="visible" variants={container}>
          ...
          >
            <div className="relative h-24 w-24 shrink-0 overflow-hidden rounded-full ring-2 ring-cobalt/40 sm:h-32 sm:w-32">
              <Image
                src="/avatar.jpg"
                alt="Ravin Vasudev"
                fill
            ...
            <div>
              ...
              <h1 className="mt-2 text-4xl font-bold leading-[1.08] sm:text-5xl lg:text-6xl">
                {profile.name}
              </h1>
            </div>
          </motion.div>
      ...
      <motion.a
        ...
        href="#impact"
        className="flex w-full items-center justify-center gap-2 border-t border-hairline py-4 font-mono text-xs uppercase tracking-[0.2em] text-muted transition-colors hover:text-ink"
      >
        <ArrowDown size={14} />
